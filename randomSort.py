# Will sort through a folder and assign numbers so they appear in a random order
# Great for sorting thorough images for a slide show
# Simply run in the directory you want it to sort through
